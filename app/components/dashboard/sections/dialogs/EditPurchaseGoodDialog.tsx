...
type EditPurchaseGoodDialogProps = {
    open: boolean;
...
export function EditPurchaseGoodDialog({ open, onOpenChange, onSubmit, purchaseGood, backgroundColor }: EditPurchaseGoodDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className={cn("sm:max-w-[500px]", backgroundColor)}>
                <DialogHeader>
                    <DialogTitle>编辑采购商品</DialogTitle>
                </DialogHeader>
                <Form {...form}>
